...
class Attack(object):
    ...
    def __init__(self, name, model1, model2, model3):
        r"""
        ...
        self.set_model(model1, model2, model3)
        ...
        self._set_auto_normalization_used(model1, model2, model3)
    ...
    @wrapper_method
    def set_model(self, model1, model2, model3):
        self.model1 = model1
    ...
    @wrapper_method
    def _set_auto_normalization_used(self, model1, model2, model3):
    ...
    def __call__(self, inputs, labels=None, *args, **kwargs):
        ...
        return adv_inputs1, adv_inputs2, adv_inputs3
