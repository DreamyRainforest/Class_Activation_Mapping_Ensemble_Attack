...
class MultiAttack(Attack):
    ...
    Examples::
        >>> atk1 = torchatt.PGD(model, eps=8/255, alpha=2/255, iters=40, random_start=True)
        >>> atk2 = torchatt.PGD(model, eps=8/255, alpha=2/255, iters=40, random_start=True)
        >>> atk = torchatt.MultiAttack([atk1, atk2])
