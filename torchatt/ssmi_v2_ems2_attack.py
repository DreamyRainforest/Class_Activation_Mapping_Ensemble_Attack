...
class Attack(object):
    ...
    def __init__(self, name, model1, model2):
        ...
        self._set_auto_normalization_used(model1, model2)
    ...
    @wrapper_method
    def _set_auto_normalization_used(self, model1, model2):
    ...
    def __call__(self, inputs, labels=None, *args, **kwargs):
        ...
        return adv_inputs1, adv_inputs2
